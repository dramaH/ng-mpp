...
{
    public class ExtendedAttributeRepository : Repository<MPPContext, ExtendedAttribute, Guid>, IExtendedAttributeRepository
    {
        public ExtendedAttributeRepository(MPPContext context) : base(context)
        {
        }
    }
}
