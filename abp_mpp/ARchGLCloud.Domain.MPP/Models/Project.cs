...
namespace ARchGLCloud.Domain.MPP.Models
{
    ...
    /// Refer: https://docs.microsoft.com/en-us/office-project/xml-data-interchange/xml-schema-for-the-project-element?view=project-client-2016
    /// </summary>
    [Table("Projects", Schema = "mpp")]
    public class Project : MppAggregateRoot<Guid>
    {
        public Project() : base(Guid.NewGuid())
        {
